...
This structure describes the following feature:
  ...
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[features-fragmentDensityMapOffset]] pname:fragmentDensityMapOffset
...
[open,refpage='VkPhysicalDeviceMaintenance7FeaturesKHR',desc='Structure describing whether the implementation supports maintenance7 functionality',type='structs']
--
The sname:VkPhysicalDeviceMaintenance7FeaturesKHR structure is defined as:

include::{generated}/api/structs/VkPhysicalDeviceMaintenance7FeaturesKHR.adoc[]
...
This structure describes the following feature:
  ...
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[features-maintenance7]] pname:maintenance7 indicates that the
    implementation supports the following:
  ** The ename:VK_RENDERING_CONTENTS_INLINE_BIT_KHR and
     ename:VK_SUBPASS_CONTENTS_INLINE_AND_SECONDARY_COMMAND_BUFFERS_KHR
     flags can: be used to record commands in render pass instances both
     inline and in secondary command buffers executed with
     flink:vkCmdExecuteCommands for dynamic rendering and legacy render
     passes respectively.
  ** Querying information regarding the underlying devices in environments
     ...
     slink:VkPhysicalDeviceLayeredApiPropertiesListKHR to
...
:refpage: VkPhysicalDeviceMaintenance7FeaturesKHR
include::{chapters}/features.adoc[tag=features]

include::{generated}/validity/structs/VkPhysicalDeviceMaintenance7FeaturesKHR.adoc[]
--
...
[open,refpage='VkPhysicalDeviceImageViewMinLodFeaturesEXT',desc='Structure describing whether clamping the min LOD of an image view is supported by the implementation',type='structs']
--
...
[open,refpage='VkPhysicalDeviceAntiLagFeaturesAMD',desc='Structure describing whether VK_AMD_anti_lag can be supported by an implementation. ',type='structs']
--
The sname:VkPhysicalDeviceAntiLagFeaturesAMD structure is defined as:

include::{generated}/api/structs/VkPhysicalDeviceAntiLagFeaturesAMD.adoc[]
...
This structure describes the following feature:
  ...
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[features-antiLag]] pname:antiLag indicates whether the implementation
    supports AMD Radeon™ Anti-Lag functionality.
    The `antiLag` feature only supports a single GPU and must: not be
    enabled if
    slink:VkDeviceGroupDeviceCreateInfo::pname:physicalDeviceCount is
    greater than 1.

:refpage: VkPhysicalDeviceAntiLagFeaturesAMD
include::{chapters}/features.adoc[tag=features]

include::{generated}/validity/structs/VkPhysicalDeviceAntiLagFeaturesAMD.adoc[]
--
...
[open,refpage='VkPhysicalDeviceMemoryVenusFdExportFeaturesEXT', desc='Structure describing features supported by VK_EXT_memory_venus_fd_export',type='structs']
--
The sname:VkPhysicalDeviceMemoryVenusFdExportFeaturesEXT structure is
defined as:

include::{generated}/api/structs/VkPhysicalDeviceMemoryVenusFdExportFeaturesEXT.adoc[]
...
This structure describes the following feature:
  ...
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[features-memoryVenusFdExport]] pname:memoryVenusFdExport specifies
    that the implementation supports:
    ** flink:vkGetMemoryVenusFdEXT, which exports compatible
       slink:VkDeviceMemory as a POSIX file descriptor with Venus-specific
       capabilities.
    ** slink:VkMemoryVenusFdExportAllocateInfoEXT, which allocates a
       slink:VkDeviceMemory with that is compatible with
       flink:vkGetMemoryVenusFdEXT by chaining to slink:VkMemoryAllocateInfo.
    ** flink:vkGetMemoryVenusFdExportPropertiesEXT, which queries the
       supported Venus-specific capabilities of a slink:VkMemoryType.

:refpage: VkPhysicalDeviceMemoryVenusFdExportFeaturesEXT
include::{chapters}/features.adoc[tag=features]

include::{generated}/validity/structs/VkPhysicalDeviceMemoryVenusFdExportFeaturesEXT.adoc[]
--
...
[open,refpage='VkPhysicalDeviceShaderRelaxedExtendedInstructionFeaturesKHR',desc='Structure describing support for VK_KHR_shader_relaxed_extended_instruction an implementation',type='structs']
--
The sname:VkPhysicalDeviceShaderRelaxedExtendedInstructionFeaturesKHR
structure is defined as:

include::{generated}/api/structs/VkPhysicalDeviceShaderRelaxedExtendedInstructionFeaturesKHR.adoc[]
...
This structure describes the following feature:
  ...
  * [[features-shaderRelaxedExtendedInstruction]]
    pname:shaderRelaxedExtendedInstruction specifies whether the
    implementation supports SPIR-V modules that use the
    code:SPV_KHR_relaxed_extended_instruction extension.

:refpage: VkPhysicalDeviceShaderRelaxedExtendedInstructionFeaturesKHR
include::{chapters}/features.adoc[tag=features]

include::{generated}/validity/structs/VkPhysicalDeviceShaderRelaxedExtendedInstructionFeaturesKHR.adoc[]
--
...
ifdef::VK_KHR_maintenance7[]
  * <<features-maintenance7, pname:maintenance7>>, if the
    `apiext:VK_KHR_maintenance7` extension is supported.
endif::VK_KHR_maintenance7[]
ifdef::VK_EXT_image_2d_view_of_3d[]
...
ifdef::VK_KHR_shader_relaxed_extended_instruction[]
  * <<features-shaderRelaxedExtendedInstruction,
    pname:shaderRelaxedExtendedInstruction>> if the
    `apiext:VK_KHR_shader_relaxed_extended_instruction` extension is
    supported.
endif::VK_KHR_shader_relaxed_extended_instruction[]
ifdef::VK_EXT_memory_venus_fd_export[]
  * <<features-memoryVenusFdExport,
    pname:memoryVenusFdExport>> if the
    `apiext:VK_EXT_memory_venus_fd_export` extension is supported.
endif::VK_EXT_memory_venus_fd_export[]
